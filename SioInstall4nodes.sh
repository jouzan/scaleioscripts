...
ssh root@172.30.227.32 "MDM_ROLE_IS_MANAGER=1 rpm -ivh EMC-ScaleIO-mdm*"
ssh root@172.30.227.33 "MDM_ROLE_IS_MANAGER=0 rpm -ivh EMC-ScaleIO-mdm*"
echo " " 
echo " " 
echo " " 
echo " "
...
ssh root@172.30.227.32 "TOKEN=P@ssw0rd rpm -ivh EMC-ScaleIO-lia*"
ssh root@172.30.227.33 "TOKEN=P@ssw0rd rpm -ivh EMC-ScaleIO-lia*"
ssh root@172.30.227.34 "TOKEN=P@ssw0rd rpm -ivh EMC-ScaleIO-lia*"
...
ssh root@172.30.227.32 "rpm -ivh EMC-ScaleIO-sds*"
ssh root@172.30.227.32 "rpm -ivh EMC-ScaleIO-sds*"
ssh root@172.30.227.34 "rpm -ivh EMC-ScaleIO-sds*"
...
echo "######################################################################"
scli --add_sds --sds_ip $mdm1 --device_path "/dev/sdb,/dev/sdc,/dev/sdd" --protection_domain_name PD1 --storage_pool_name POOL1 --sds_name sds1
scli --add_sds --sds_ip $mdm2 --device_path "/dev/sdb,/dev/sdc,dev/sdd" --protection_domain_name PD1 --storage_pool_name POOL1 --sds_name sds2
scli --add_sds --sds_ip $tb --device_path "/dev/sdb,/dev/sdc,/dev/sdd" --protection_domain_name PD1 --storage_pool_name POOL1  --sds_name sds3
scli --add_sds --sds_ip $sds4 --device_path "/dev/sdb,/dev/sdc,/dev/sdd" --protection_domain_name PD1 --storage_pool_name POOL1 --sds_name sds4
...
echo "############################################################################"
MDM_IP=192.168.6.31,192.168.8.31,192.168.8.32,192.168.6.32 rpm -ivh EMC-ScaleIO-sdc-2.0-12000.122.el7.x86_64.rpm
...
echo "############################################################################"
scli --map_volume_to_sdc --volume_name VOL0000 --sdc_ip 192.168.6.31  
scli --map_volume_to_sdc --volume_name VOL0001 --sdc_ip 192.168.6.31
scli --map_volume_to_sdc --volume_name VOL0002 --sdc_ip 192.168.6.31
